            ...
            if (args[0].equalsIgnoreCase("give")) {
                ...
                if (args.length == 2) {
                    if (args[1].equalsIgnoreCase("LightningBow")) {
                        ...
                        lBowMeta.setDisplayName("" + ChatColor.AQUA + ChatColor.BOLD + "Lightning Bow");
                    ...
                    if (args[1].equalsIgnoreCase("TntBow")) {
                        ItemStack lBow = new ItemStack(Material.BOW, 1);
                        ItemMeta lBowMeta = lBow.getItemMeta();
                        lBowMeta.setDisplayName("" + ChatColor.RED + ChatColor.BOLD + "Tnt Bow");
                    ...
                    if (args[1].equalsIgnoreCase("EnderBow")) {
                        ItemStack lBow = new ItemStack(Material.BOW, 1);
                        ItemMeta lBowMeta = lBow.getItemMeta();
                        lBowMeta.setDisplayName("" + ChatColor.LIGHT_PURPLE + ChatColor.BOLD + "Ender Bow");
